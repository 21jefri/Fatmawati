 ...
 <div class="page-wrapper mt-5">
 	...
 	<div class="row">
 		<div class="col-sm-4">
 			<div class="card card-primary mb-3">
 				<div class="card-header bg-primary text-white">
 					<h5 style="transform: translateY(4px);" class="text-white"><i class="fa fa-search text-white"></i> Cari Barang</h5>
 				</div>
 				<div class="card-body">
 		...
 		<div class="col-sm-8">
 			<div class="card card-primary mb-3">
 				<div class="card-header bg-primary text-white">
 					<h5 style="transform: translateY(6px);" class="text-white"><i class="fa fa-list text-white"></i> Hasil Pencarian</h5>
 				</div>
 				<div class="card-body">
 		...
 		<div class="col-sm-12">
 			<div class="card card-primary">
 				<div class="card-header bg-primary text-white">
 					<h5 style="transform: translateY(6px);" class="text-white"><i class="fa fa-shopping-cart text-white"></i> KASIR
 						<a class="btn btn-danger float-right" style="transform: translateY(-6px);" onclick="javascript:return confirm('Apakah anda ingin reset keranjang ?');" href="fungsi/hapus/hapus.php?penjualan=jual">
										...
										if (!empty($bayar)) {
											...
											if ($bayar >= $total) {
												...
												for ($x = 0; $x < $jumlah_dipilih; $x++) {
													...
													// ubah stok barang
													$sql_barang = "SELECT * FROM produk WHERE id_barang = ?";
													...
													// echo $total_stok;
													$sql_stok = "UPDATE produk SET stok = ? WHERE id_barang = ?";
