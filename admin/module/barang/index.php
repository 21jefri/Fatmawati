                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="fungsi/edit/edit.php?stok=edit">
                                    ...
                                    <a href="fungsi/hapus/hapus.php?produk=hapus&id=<?php echo $isi['id_barang']; ?>"
...
?>
            ...
            <input type="text" readonly="readonly" required value="<?php echo $format; ?>"
        ...
        <div class="">
            ...
            <input type="text" placeholder="Nama Barang" required class="form-control"
                                            name="nama">
        </div>
        <div class="">
            <label for="" class="form-label">Merk Barang</label>
            <input type="text" placeholder="Merk Barang" required class="form-control"
                                            name="merk">
        </div>
        <div class="">
            <label for="" class="form-label">Harga Beli</label>
            <input type="number" placeholder="Harga beli" required class="form-control"
                                            name="beli">
        </div>
        <div class="">
            <label for="" class="form-label">Harga Jual</label>
            <input type="number" placeholder="Harga Jual" required class="form-control"
                                            name="jual">
        </div>
        <div class="">
        ...
        <div class="">
            ...
            <input type="number" required Placeholder="Stok" class="form-control"
                                            name="stok">
        </div>
        <div class="">
