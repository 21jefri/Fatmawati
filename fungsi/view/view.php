...
class view
{
    ...
    {
        $sql ="SELECT nota.* , produk.id_barang, produk.nama_barang, produk.harga_beli, member.id_member,
                member.nm_member from nota 
                left join produk on produk.id_barang=nota.id_barang 
    ...
    {
        $sql ="SELECT penjualan.* , produk.id_barang, produk.nama_barang, member.id_member,
                member.nm_member from penjualan 
                left join produk on produk.id_barang=penjualan.id_barang 
